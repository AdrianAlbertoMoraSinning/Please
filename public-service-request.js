...
exports.handler=async event=>{
  try{
    ...
    const adminNotification=await notify.sendAdmins({
      ...
      details:[['Request',item.reference],['Service',service.name],['Customer',`${first} ${last}`.trim()],['Email',email],['Phone',phone],['Preferred date',p.preferred_date||'To be coordinated'],['Preferred time',p.preferred_start_time||'To be coordinated']],
      message:desc,
