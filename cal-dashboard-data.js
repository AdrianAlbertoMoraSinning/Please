...
exports.handler=async event=>{
  ...
  try{
    ...
    const [legal,company,accounts,entries,lines,invoices,expenses,payments,creditNotes,refunds,parties,operationalInvoices,events,outbox,healthRaw]=await Promise.all([
