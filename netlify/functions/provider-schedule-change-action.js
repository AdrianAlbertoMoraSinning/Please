...
exports.handler=async event=>{
  ...
  try{
    ...
    if(!assignmentId||!proposedStart||!proposedEnd||new Date(proposedEnd)<=new Date(proposedStart))return lib.json(400,{error:'A valid proposed date, start and end time are required.'});
