...
exports.handler=async event=>{
  ...
  try{
    ...
    if(action==='MARK_PAID'){
      ...
      return lib.json(200,{ok:true,status:'PAID',amount:money(p.amount),advance_applied:advanceApplied,cash_paid:remaining,advances_enabled:advancesEnabled,notification_sent:!!n?.sent,accounting_mode:'EVENT_DRIVEN'});
    }
