...
exports.handler=async event=>{
  ...
  try{
    ...
    const [jobs,assignments,providers,services,jobHistory,assignmentHistory,billingItems,scheduleChanges]=await Promise.all([
      ...
      lib.sbJson('/rest/v1/job_billing_items?select=id,job_id,service_name,description,quantity,unit,unit_rate,line_total,sort_order&order=job_id.asc,sort_order.asc'),
