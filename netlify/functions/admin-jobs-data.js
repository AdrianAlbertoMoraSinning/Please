...
exports.handler=async event=>{
  ...
  try{
    ...
    const [jobs,assignments,providers,services,jobHistory,assignmentHistory,billingItems,scheduleChanges,evidence,serviceRequests]=await Promise.all([
    ...
    return lib.json(200,{jobs:jobs||[],assignments:assignments||[],providers:providers||[],services:services||[],job_history:jobHistory||[],assignment_history:assignmentHistory||[],job_billing_items:billingItems||[],schedule_changes:scheduleChanges||[],evidence:evidence||[],service_requests:serviceRequests||[]});
