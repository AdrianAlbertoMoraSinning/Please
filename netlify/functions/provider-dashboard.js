...
exports.handler=async event=>{
  ...
  try{
    ...
    const [providers,ps,services,av,ex,assignRaw,rates,changeRequests,extensions,documents,technicalHistory,account,servicePhotos,serviceEvents]=await Promise.all([
      providerRow(q),
