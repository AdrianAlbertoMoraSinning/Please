...
exports.handler=async event=>{
  ...
  try{
    ...
    const [providers,ps,services,av,ex,assignRaw,rates,changeRequests,extensions,documents,technicalHistory,account,servicePhotos,evidence,serviceEvents]=await Promise.all([
      ...
      safeJson(`/rest/v1/job_service_evidence?select=id,job_id,assignment_id,evidence_type,storage_path,mime_type,created_at&provider_id=eq.${q}&status=eq.COMMITTED&order=created_at.desc&limit=200`),
