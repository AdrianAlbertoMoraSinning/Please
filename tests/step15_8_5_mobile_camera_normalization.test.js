...
ok(/js\/provider\.js\?v=(?:15\.8\.(?:[5-9]|\d{2,})(?:\.\d+)*|15\.(?:9|\d{2,})|19\.0)/.test(html), 'Provider page cache-busts the updated camera JavaScript');
ok(/please-provider-(?:v15-(?:8-5|8-[6-9](?:-\d+)*|9|\d{2,})|v19)/.test(sw), 'Provider PWA service-worker cache version advanced');
