...
ok(evidenceLib.includes("new Set(['CHECK_IN','ARRIVAL','COMPLETION','CHECK_OUT'])")&&liveFn.includes("CHECK_IN:'CHECK_IN'")&&liveFn.includes("CHECK_OUT:'CHECK_OUT'")&&sql.includes("v_worker_type='PLEASE_STAFF'"),'PLEASE Staff four-photo lifecycle is enforced client/backend/database');
