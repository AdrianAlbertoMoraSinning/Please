...
ok(maint.includes('schedule.updateActiveJob')&&maintJs.includes('SAVE JOB SCHEDULE & HOURS')&&maintHtml.includes('v=15.9.1'),'Service Maintenance can edit active Job date/start/hours and synchronize hourly billing');
